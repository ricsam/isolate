...
// Resolve node_modules relative to this script (in demo/scripts/)
const demoDir = dirname(import.meta.dir);
const nodeModulesPath = join(demoDir, "node_modules");
...
async function buildLibraryTypes() {
  ...
  const output = `/**
 * Auto-generated library type definitions for QuickJS typechecking
 * Generated by: bun demo/scripts/build-library-types.ts
 * DO NOT EDIT MANUALLY
 */

import type { LibraryTypes } from "@ricsam/quickjs-test-utils";
